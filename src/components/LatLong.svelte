...
{:else}
	<div class="mdc-typography--body1">
		...
		<span class="mdc-typography--subtitle2">Lat:</span>
		<span class="number">{position?.latitude ?? 'Loading...'}</span>
		<span class="mdc-typography--subtitle2">Long:</span>
		<span class="number">{position?.longitude ?? 'Loading...'}</span>
